...
# Path
filepath = r"D:\Jiejie stuff\CAM N-N\Hydrogel\p\1.tif"
downloadPath = r"D:\Jiejie stuff\Shell_Program\Download\1"
...
cv.imshow('img_origin | img_mean | img_gaussian |img_skel ', np.hstack([img_greyscale, img_mean, img_gaussian, img_skel]))
